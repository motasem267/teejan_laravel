...
<body>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr class="total-row">
                ...
                <td class="amount">{{ number_format($total, 2) }} دينار</td>
                <td colspan="2"></td>
            </tr>
        </tbody>
    </table>
    ...
    <div class="summary-box">
        <div class="summary-item">
            ...
            <strong>{{ number_format($total, 2) }} دينار</strong>
        </div>
        <div class="summary-item">
        ...
        <div class="summary-item">
            <span>المتوسط:</span>
            <strong>{{ count($records) > 0 ? number_format($total / count($records), 2) : 0 }} دينار</strong>
        </div>
    </div>
